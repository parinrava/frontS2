...
function insertPatient() {
    ...
    xhr.open("POST", "https://backs5-h8f9hqguend9bhg4.westus-01.azurewebsites.net/api/insert", true); // Use localhost
...
function runQuery() {
    ...
    if (method === "GET") {
        xhr.open("GET", `https://backs5-h8f9hqguend9bhg4.westus-01.azurewebsites.net/api/query?sql=${encodeURIComponent(query)}`, true); // Use localhost
    } else {
        xhr.open("POST", "https://backs5-h8f9hqguend9bhg4.westus-01.azurewebsites.net/api/query", true); // Use localhost
        xhr.setRequestHeader("Content-Type", "application/json");
    }
